...
function igthemes_page_meta() {
    add_meta_box( 'igthemes_meta', __( 'Page Settings', 'base-wp' ), 'igthemes_meta_callback', 'page','side' );
}
...
function igthemes_meta_callback( $post ) {
    ...
    ?>
    <p>
        <span class="igthemes-row-title"><strong><?php _e( 'Page title', 'base-wp' )?></strong></span>
        <div class="igthemes-row-content">
            <label for="igthemes-page-title">
                ...
                <?php _e( 'Hide page title', 'base-wp' )?>
            </label>
        </div>
    </p>
